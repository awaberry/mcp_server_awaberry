...
(async () => {
  ...
  try {
    ...
    if (statusRes) {
      ...
      // in case your commands return ">" - a previous incomplete command might have messed it up - send ctrlc to fix it
      // const controlC = 'ctrlc';
      // const resultCrtlC = await client.executeCommand(deviceuuid, controlC);
      // console.log("Response send ctrlc: " , resultCrtlC.commandResult);
