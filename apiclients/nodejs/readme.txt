Awaberry API client for node.js

See usageExampleBasic.js for a end to end example of calling a device programmatically using the awaBerry api based on a configured project.
